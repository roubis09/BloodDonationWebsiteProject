  ...
  $mobile=$_POST['t4'];
    ...
    try{
            ...
            $_SESSION['email']= $email;
						...
						$sql= "INSERT INTO `donate`(`name`, `gender`, `age`, `mobile`, `email`, `blood`, `email1`) VALUES ('$name','$gender','$age','$mobile','$email', '$blood','$email')";
...
<tr><td colspan="2">&nbsp;</td></tr>
                ...
                <tr><td  style=" padding-left:20px;" ><img src="Images/donate.jpeg" width="170px" class="shaddoww"/>&nbsp; </td>
                    <td style="vertical-align:top;padding-top:20px;">
                    <table cellpadding="0" cellspacing="0" style="width:100%; height:400px;">
<form method="post" action=#>
    <tr><td class="lefttd">Donor Name:</td><td><input type="text" name="t1" required="required" pattern="[a-zA-Z _]{2,50}" title="please enter donor name" /></td></tr>

    <tr><td class="lefttd">Gender</td><td><input name="t2" type="radio" value="male" checked="checked">Male<input name="t2" type="radio" value="female">Female</td></tr>

    <tr><td class="lefttd">Age</td><td><input type="number" name="t3" required="required" pattern="[0-9]{1,100}" title="please enter age" /></td></tr>
    <tr><td class="lefttd">Mobile No</td><td><input type="tel" name="t4" required="required" pattern="[0-9+]{10,13}" title="please enter valid mobile no.Don't give any space after country code" /></td></tr>
